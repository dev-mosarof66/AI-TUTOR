  ...
  return (
    <section className="relative min-h-screen pt-24 flex items-center justify-center overflow-hidden bg-gray-300 dark:bg-gray-900 text-gray-900 dark:text-gray-300">
      ...
      <motion.div
        ...
        className="absolute top-20 left-10 w-48 h-48 bg-purple-600/50 rounded-full blur-3xl"
      />
      <motion.div
        initial={{ scale: 0.8, opacity: 0 }}
        animate={{ scale: 1, opacity: 0.1 }}
        transition={{ duration: 2, repeat: Infinity, repeatType: "mirror", delay: 1 }}
        className="absolute bottom-20 right-10 w-48 h-48 bg-purple-600/50 rounded-full blur-3xl"
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="space-y-8">
          ...
          >
            <div className="p-3 sm:p-6 rounded-xl border dark:border-gray-700 shadow-lg bg-gray-100 dark:bg-gray-800">
          ...
          >
            <button className="w-full sm:w-fit bg-purple-600 text-white font-semibold rounded-xl px-6 py-2 active:scale-[0.97] transition duration-300 delay-75 flex items-center justify-center gap-2 group hover:bg-purple-700">
              <Play className="h-5 w-5 group-hover:scale-110 transition-all duration-300" />
              Start Learning
            </button>
            <button className="w-full sm:w-fit border border-purple-500 text-purple-600 dark:text-purple-400 font-semibold rounded-xl px-6 py-2 flex items-center justify-center gap-2 group hover:bg-purple-50 dark:hover:bg-gray-800 transition">
              <FaVideo className="h-5 w-5 group-hover:scale-110 transition-all duration-300" />
              Watch Demo
            </button>
          </motion.div>
